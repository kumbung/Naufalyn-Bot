...
from Naufalyn_Bot import (DEV_USERS, OWNER_ID, SUDO_USERS, SUPPORT_CHAT,
                          SUPPORT_USERS, TIGER_USERS, WHITELIST_USERS,
                          dispatcher)
from Naufalyn_Bot.modules.helper_funcs.chat_status import (dev_plus, sudo_plus,
                                                           whitelist_plus)
from Naufalyn_Bot.modules.helper_funcs.extraction import extract_user
from Naufalyn_Bot.modules.log_channel import gloggable
from telegram import ParseMode, TelegramError, Update
from telegram.ext import CallbackContext, CommandHandler, run_async
from telegram.utils.helpers import mention_html

ELEVATED_USERS_FILE = os.path.join(os.getcwd(),
                                   'Naufalyn_Bot/elevated_users.json')
...
disasters = """ Naufalyn has bot access levels we call as *"Disaster Levels"*
...
Owner has complete bot access, including bot adminship in chats Naufalyn is at.
\n*Dragons* - Have super user access, can gban, manage disasters lower than them and are admins in Naufalyn.
\n*Demons* - Have access go globally ban users across Naufalyn.
...
\n*Disclaimer*: The disaster levels in Naufalyn are there for troubleshooting, support, banning potential scammers.
