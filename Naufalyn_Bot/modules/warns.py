...
import telegram
from Naufalyn_Bot import BAN_STICKER, TIGER_USERS, WHITELIST_USERS, dispatcher
from Naufalyn_Bot.modules.disable import DisableAbleCommandHandler
from Naufalyn_Bot.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           is_user_admin,
                                                           user_admin,
                                                           user_admin_no_reply)
from Naufalyn_Bot.modules.helper_funcs.extraction import (extract_text,
                                                          extract_user,
                                                          extract_user_and_text)
from Naufalyn_Bot.modules.helper_funcs.filters import CustomFilters
from Naufalyn_Bot.modules.helper_funcs.misc import split_message
from Naufalyn_Bot.modules.helper_funcs.string_handling import split_quotes
from Naufalyn_Bot.modules.log_channel import loggable
from Naufalyn_Bot.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        message.bot.send_sticker(chat.id, BAN_STICKER)  # Naufalyn's sticker
        keyboard = []
