...
import Naufalyn_Bot.modules.sql.global_bans_sql as gban_sql
import Naufalyn_Bot.modules.sql.users_sql as user_sql
from Naufalyn_Bot import DEV_USERS, OWNER_ID, dispatcher
